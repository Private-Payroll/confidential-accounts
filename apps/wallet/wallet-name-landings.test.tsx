...
import { loadSecret, savePasskey, saveWalletName, walletNameOf, walletNameOnRecord } from './storage.js';
import { ORIGINAL_SLOT, forgetOpenWallet, openWallet, openWalletId } from './wallets-held.js';
...
describe('the enumeration is the claim, so the enumeration is pinned', () => {
  it('has exactly four callers of saveSecret, and every one of them settles the name',
    async () => {
      ...
      const source = await fs.readFile('apps/wallet/session.tsx', 'utf8');
