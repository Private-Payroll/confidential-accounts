...
import { unshieldedAddressFor } from '../unshielded.js';
 ...
 * the screen rather than in the registry: `../derived.ts`. */
import { derive } from '../derived.js';
import type { Derived } from '../derived.js';
/* Which wallet a company is OFFERED, which is a rule and a default
 * rather than a refusal: `../slot-choice.ts`. */
import { alsoUsedBy, chooseSlot } from '../slot-choice.js';
import { WALLET_ACCOUNTS, displayNameOf } from '../subwallets.js';
...
export function Approve({
   ...
   * `../slot-choice.ts` decides it; this is only where it is applied.
   *
