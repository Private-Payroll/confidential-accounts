...
import type { BalanceState, StopBalance } from '../chain/balance.js';
...
import { splitShortAddress } from '../accounts/short-address.js';
import { arrivalOf, creationOf, loadSecuredSetup } from '../accounts/storage.js';
...
import type { PendingSend, ResolutionDoors } from '../chain/pending.js';
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* WHAT IS WAITING FOR YOU SOMEWHERE ELSE.
        ...
        * (`../components/inbox-card.tsx`). It renders in every state including the one
        ...
        * (`../accounts/inbox-live.ts`), the way the chip and this screen both subscribe
