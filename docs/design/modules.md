...
|---|---|
| modules walked | 397 |
| module-to-module import sites | 1383 |
| modules that could not be read | 0 |
| specifiers that resolved to nothing | 0 |
| specifiers naming a real file outside the walked set | 93 |
| call sites carrying a literal circuit name | 464 |
...
| `src/midnight/commitments.ts` | 1 | 3 | 19 | 2 | 3 | 0 | 12 |
| `src/core/signer-leaf.ts` | 1 | 2 | 7 | 9 | 2 | 1 | 0 |
| `src/core/crypto.ts` | 1 | 0 | 118 | 28 | 2 | 7 | 0 |
| `src/midnight/payee-address.ts` | 1 | 2 | 21 | 12 | 11 | 1 | 0 |
| `src/core/payslip-key.ts` | 1 | 3 | 3 | 2 | 1 | 0 | 0 |
| `src/core/payslip-key-derive.ts` | 1 | 1 | 3 | 1 | 1 | 3 | 0 |
| `src/midnight/ledger.ts` | 2 | 9 | 16 | 46 | 49 | 5 | 14 |
| `src/midnight/vault-ledger.ts` | 2 | 10 | 15 | 14 | 24 | 0 | 24 |
| `src/midnight/vault-notes.ts` | 2 | 3 | 12 | 10 | 16 | 0 | 24 |
| `src/midnight/vault-coins.ts` | 2 | 1 | 7 | 4 | 7 | 0 | 0 |
| `src/core/movement.ts` | 2 | 4 | 7 | 9 | 6 | 0 | 1 |
...
| `ConfidentialAccount.assetKeyOf` | `contracts/test/commitments.test.ts` `contracts/test/one-definition.test.ts` `contracts/test/simulator.ts` `scripts/run-preview.ts` `src/midnight/commitments.ts` | 113 |
| `ConfidentialAccount.changeCommitmentOf` | `contracts/test/commitments.test.ts` `contracts/test/one-definition.test.ts` `contracts/test/the-service-layer-meets-the-chain.test.ts` `src/midnight/commitments.ts` `src/midnight/ledger.ts` | 113 |
...
| `ConfidentialAccount.removeSignerPayload` | `contracts/test/one-definition.test.ts` `contracts/test/signer-governance.test.ts` `contracts/test/vault-threshold-recovery.test.ts` `scripts/governance-steps.ts` `scripts/measure-call-cost.ts` `src/midnight/commitments.ts` | 112 |
...
| `ConfidentialAccount.allVaults` | `contracts/test/one-definition.test.ts` `contracts/test/vault-scoping.test.ts` `scripts/diagnose-state.ts` `scripts/prove-compare.ts` `scripts/run-preview.ts` `scripts/sponsor-test.ts` `src/midnight/commitments.ts` | 96 |
| `ConfidentialAccount.noVault` | `contracts/test/one-definition.test.ts` `contracts/test/payout-runs.test.ts` `contracts/test/vault-scoping.test.ts` `contracts/test/vault-threshold-recovery.test.ts` `scripts/governance-steps.ts` `scripts/run-preview.ts` `src/midnight/commitments.ts` `src/midnight/ledger.test.ts` | 114 |
| `ConfidentialAccount.paidMovementOf` | `contracts/test/a-retry-lives-on-the-leg-it-retries.test.ts` `contracts/test/nobody-is-paid-twice-by-a-restart.test.ts` `contracts/test/one-definition.test.ts` `contracts/test/payout-runs.test.ts` `contracts/test/the-payroll-run-meets-the-chain.test.ts` `contracts/test/transcript.test.ts` `contracts/test/vault-client.test.ts` `contracts/test/vault-payout.test.ts` `contracts/test/vault-scoping.test.ts` `contracts/test/vault-threshold-recovery.test.ts` `contracts/test/vault-unshielded.test.ts` `src/midnight/ledger.ts` | 99 |
...
| `ConfidentialAccount.payoutLeaf` | `contracts/test/one-definition.test.ts` `contracts/test/payout-runs.test.ts` `contracts/test/vault-scoping.test.ts` `src/midnight/payout-tree.ts` | 138 |
| `ConfidentialAccount.setVaultThresholdPayload` | `contracts/test/one-definition.test.ts` `contracts/test/vault-registry.test.ts` `contracts/test/vault-scoping.test.ts` `contracts/test/vault-threshold-recovery.test.ts` `scripts/measure-call-cost.ts` `src/midnight/commitments.ts` | 110 |
| `ConfidentialAccount.vacantSlot` | `contracts/test/one-definition.test.ts` `contracts/test/simulator.ts` `contracts/test/what-a-signer-is.test.ts` `scripts/governance-steps.ts` `src/midnight/ledger.test.ts` `src/midnight/ledger.ts` | 100 |
...
| `ConfidentialAccount.propose` | `contracts/test/simulator.ts` `scripts/cross-contract-spike.ts` `scripts/governance-steps.ts` `scripts/measure-call-cost.ts` `scripts/pay-from-vault.ts` `scripts/run-preview.ts` `src/web/proving-runner.test.ts` | 31 |
| `ConfidentialAccount.approve` | `contracts/test/simulator.ts` `scripts/governance-steps.ts` `scripts/measure-call-cost.ts` `scripts/pay-from-vault.ts` `scripts/run-preview.ts` `src/midnight/job-runner.test.ts` `src/midnight/what-a-balance-books.test.ts` | 31 |
...
| `ConfidentialAccount.recordPayment` | `contracts/test/simulator.ts` `scripts/measure-call-cost.ts` | 73 |
...
| `Vault.payoutDetails` | `contracts/test/transcript.test.ts` `contracts/test/vault-client.test.ts` `contracts/test/vault-payout.test.ts` `contracts/test/vault-recovery.test.ts` `contracts/test/vault-registry.test.ts` `contracts/test/vault-split.test.ts` `contracts/test/vault-threshold-recovery.test.ts` `scripts/measure-call-cost.ts` | 56 |
| `Vault.unshieldedPayoutDetails` | `contracts/test/vault-client.test.ts` `scripts/pay-from-vault-rules.test.ts` | 50 |
| `Vault.heldCommitmentOf` | `contracts/test/vault-payout.test.ts` `contracts/test/vault-split.test.ts` `src/midnight/vault-ledger.test.ts` | 57 |
| `Vault.noteBlindingOf` | `contracts/test/vault-payout.test.ts` `contracts/test/vault-split.test.ts` `src/midnight/vault-ledger.test.ts` | 57 |
| `Vault.deposit` | `contracts/test/transcript.test.ts` `contracts/test/vault-client.test.ts` `contracts/test/vault-payout.test.ts` `contracts/test/vault-recovery.test.ts` `contracts/test/vault-registry.test.ts` `contracts/test/vault-split.test.ts` `contracts/test/vault-threshold-recovery.test.ts` `contracts/test/vault-unshielded.test.ts` `scripts/chain-probe.ts` `scripts/measure-call-cost.ts` `src/midnight/vault-call-convention.test.ts` `src/midnight/vault-ledger.test.ts` `src/midnight/vault-ledger.ts` | 56 |
| `Vault.depositUnshielded` | `contracts/test/vault-client.test.ts` `contracts/test/vault-unshielded.test.ts` `src/midnight/vault-ledger.test.ts` `src/midnight/vault-ledger.ts` | 50 |
| `Vault.payout` | `contracts/test/transcript.test.ts` `contracts/test/vault-client.test.ts` `contracts/test/vault-payout.test.ts` `contracts/test/vault-recovery.test.ts` `contracts/test/vault-registry.test.ts` `contracts/test/vault-split.test.ts` `contracts/test/vault-threshold-recovery.test.ts` `contracts/test/vault-unshielded.test.ts` `scripts/cross-contract-spike.ts` `scripts/measure-call-cost.ts` `src/midnight/vault-call-convention.test.ts` `src/midnight/vault-ledger.test.ts` `src/midnight/vault-ledger.ts` | 56 |
| `Vault.payoutUnshielded` | `contracts/test/vault-client.test.ts` `contracts/test/vault-unshielded.test.ts` `src/midnight/vault-ledger.test.ts` `src/midnight/vault-ledger.ts` | 50 |
...
- **imported by** — `contracts/test/a-leg-is-raised-again-as-itself.test.ts`, `contracts/test/a-payroll-the-vault-cannot-pay-is-not-raised.test.ts`, `contracts/test/a-retry-lives-on-the-leg-it-retries.test.ts`, `contracts/test/a-run-carries-its-own-material.test.ts`, `contracts/test/approvals.test.ts`, `contracts/test/commitments.test.ts`, `contracts/test/nobody-is-paid-twice-by-a-restart.test.ts`, `contracts/test/one-definition.test.ts`, `contracts/test/payout-runs.test.ts`, `contracts/test/run-keys.test.ts`, `contracts/test/run-status.test.ts`, `contracts/test/the-payroll-run-meets-the-chain.test.ts`, `contracts/test/the-service-layer-meets-the-chain.test.ts`, `contracts/test/transcript.test.ts`, `contracts/test/vault-client.test.ts`, `contracts/test/vault-payout.test.ts`, `contracts/test/vault-recovery.test.ts`, `contracts/test/vault-registry.test.ts`, `contracts/test/vault-scoping.test.ts`, `contracts/test/vault-split.test.ts`, `contracts/test/vault-threshold-recovery.test.ts`, `contracts/test/vault-unshielded.test.ts`, `contracts/test/what-a-signer-is.test.ts`, `scripts/deploy-preview.ts`, `scripts/deposit-to-vault.ts`, `scripts/fund-vault.ts`, `scripts/measure-call-cost.ts`, `scripts/pay-from-vault-rules.test.ts`, `scripts/pay-from-vault-rules.ts`, `scripts/pay-from-vault.ts`, `scripts/preview-signers.test.ts`, `scripts/preview-signers.ts`, `scripts/transfer-from-vault.test.ts`, `scripts/transfer-from-vault.ts`, `scripts/vault-pool-file.test.ts`, `src/core/a-payroll-run-is-always-private.test.ts`, `src/core/a-run-is-not-a-governance-round.test.ts`, `src/core/a-vault-must-hold-what-a-round-pays.test.ts`, `src/core/a-vault-s-own-threshold.test.ts`, `src/core/account.ts`, `src/core/challenges.ts`, `src/core/core.test.ts`, `src/core/create-company.test.ts`, `src/core/crypto.test.ts`, `src/core/demo.ts`, `src/core/identity.ts`, `src/core/invite-handover.ts`, `src/core/jobs.ts`, `src/core/ledger-token.test.ts`, `src/core/ledger.ts`, `src/core/nobody-is-paid-twice-by-a-retyped-month.test.ts`, `src/core/one-pending-employee-does-not-refuse-the-run.test.ts`, `src/core/payroll.ts`, `src/core/payslip-key-derive.ts`, `src/core/payslip-key.test.ts`, `src/core/payslip-key.ts`, `src/core/plugins.ts`, `src/core/principal.test.ts`, `src/core/principal.ts`, `src/core/sealed-records.test.ts`, `src/core/sealed-records.ts`, `src/core/sessions.ts`, `src/core/signer-leaf.ts`, `src/core/store-file.test.ts`, `src/core/store-file.ts`, `src/core/store.ts`, `src/core/the-threshold-is-the-chain-s.test.ts`, `src/core/types.ts`, `src/core/wallet-identity.ts`, `src/core/wallet-unlock.test.ts`, `src/core/which-seat-is-yours.test.ts`, `src/midnight/commitments.ts`, `src/midnight/job-runner.test.ts`, `src/midnight/job-runner.ts`, `src/midnight/ledger.test.ts`, `src/midnight/ledger.ts`, `src/midnight/note-index.ts`, `src/midnight/payee-address.ts`, `src/midnight/payout-tree.ts`, `src/midnight/private-state-addressing.test.ts`, `src/midnight/run-keys.ts`, `src/midnight/run-material.ts`, `src/midnight/run-skips.ts`, `src/midnight/run-status.ts`, `src/midnight/sealed-store.test.ts`, `src/midnight/sealed-store.ts`, `src/midnight/the-key-reaches-the-circuit.test.ts`, `src/midnight/vault-coins.test.ts`, `src/midnight/vault-coins.ts`, `src/midnight/vault-holdings.test.ts`, `src/midnight/vault-holdings.ts`, `src/midnight/vault-ledger.test.ts`, `src/midnight/vault-ledger.ts`, `src/midnight/vault-notes.test.ts`, `src/midnight/vault-notes.ts`, `src/midnight/vault-pool.test.ts`, `src/midnight/vault-pool.ts`, `src/midnight/vault-recovery.ts`, `src/server/approval-signature.test.ts`, `src/server/index.ts`, `src/server/invitations.test.ts`, `src/server/self-payee.test.ts`, `src/standalone/main.tsx`, `src/testing/payees.ts`, `src/web/App.tsx`, `src/web/Join.tsx`, `src/web/accept-seat.test.ts`, `src/web/accept-seat.ts`, `src/web/accepted-address.ts`, `src/web/after-a-company-is-unlocked.test.tsx`, `src/web/connector-wallet.ts`, `src/web/keyring.ts`, `src/web/seat-repair.test.ts`, `src/web/seat-repair.ts`, `src/web/wallet-unlock.ts`, `src/wiring/a-chain-selection-needs-marked-records.test.ts`, `src/wiring/a-service-can-read-a-vault.test.ts`, `src/wiring/chain.ts`
...
- **imported by** — `scripts/circuits-that-read-no-witness.test.ts`, `scripts/deploy-preview.ts`, `scripts/pay-from-vault.ts`, `scripts/run-preview.ts`, `scripts/sponsor-test.ts`, `src/midnight/ledger.test.ts`, `src/midnight/private-state-addressing.test.ts`, `src/midnight/providers.ts`, `src/midnight/sealed-store.ts`, `src/midnight/sponsor.ts`, `src/midnight/the-key-reaches-the-circuit.test.ts`, `src/midnight/vault-ledger.ts`, `src/midnight/what-a-balance-books.test.ts`, `src/wiring/chain.ts`, `src/wiring/write-capability-for-deployment.ts`, `src/wiring/write-capability.ts`
- **outside packages** — *none*
- **platform modules** — *none*
...
| 174 | `MidnightConfig` | `export interface MidnightConfig` |
| 212 | `FeeSponsor` | `export interface FeeSponsor` |
| 294 | `SealedStateStore` | `export interface SealedStateStore` |
| 322 | `privateStateKey` | `export const privateStateKey = (base: string, accountId: string): string =>` |
| 377 | `CIRCUITS_THAT_READ_NO_WITNESS` | `export const CIRCUITS_THAT_READ_NO_WITNESS: ReadonlySet<string> = new Set(['closeExpiredRun']);` |
| 410 | `CIRCUIT_FOR_STEP` | `export const CIRCUIT_FOR_STEP: Record<PreparedStep['kind'], string>` |
| 424 | `MidnightLedger` | `export class MidnightLedger implements Ledger` |
| 2385 | `UndecodedLedgerField` | `export class UndecodedLedgerField extends Error` |
| 2479 | `MidnightProofSystem` | `export class MidnightProofSystem implements ProofSystem` |
| 2656 | `AuthorityShape` | `export type AuthorityShape = 'anyone' \| 'no-one' \| 'one-key' \| 'committee';` |
| 2662 | `OnChainAuthority` | `export interface OnChainAuthority` |
| 2697 | `AuthorityRead` | `export type AuthorityRead` |
| 2719 | `authorityShapeOf` | `export function authorityShapeOf(` |
| 2739 | `authorityFromContractState` | `export function authorityFromContractState(` |
| 2771 | `ContractStateReader` | `export type ContractStateReader = (address: string) => Promise<unknown>;` |
| 2780 | `readContractAuthority` | `export async function readContractAuthority(` |
| 2816 | `intendedAuthorityValue` | `export function intendedAuthorityValue(` |
| 2870 | `AuthorityVerdict` | `export type AuthorityVerdict = 'agree' \| 'disagree' \| 'unknown';` |
| 2872 | `AuthorityComparison` | `export interface AuthorityComparison` |
| 2907 | `compareAuthority` | `export function compareAuthority(` |
| 3092 | `MaintenanceRefusal` | `export interface MaintenanceRefusal` |
| 3132 | `verifierKeyRefusals` | `export function verifierKeyRefusals(` |
| 3192 | `authorityValueRefusals` | `export function authorityValueRefusals(` |
| 3294 | `requireBuildableAuthority` | `export function requireBuildableAuthority(` |
| 3317 | `MaintenancePlan` | `export type MaintenancePlan` |
| 3354 | `planAuthorityReplacement` | `export function planAuthorityReplacement(` |
| 3444 | `MaintenanceEndStateRecord` | `export interface MaintenanceEndStateRecord` |
| 3481 | `EndStateVerdict` | `export type EndStateVerdict = 'settled' \| 'not-yet' \| 'unexplained' \| 'unknown';` |
| 3483 | `EndStateCheck` | `export interface EndStateCheck` |
| 3498 | `checkEndState` | `export function checkEndState(` |
| 3539 | `MaintenanceSignature` | `export type MaintenanceSignature = AuthorityKey;` |
| 3554 | `MaintenanceUpdateLike` | `export interface MaintenanceUpdateLike` |
| 3561 | `MaintenancePrimitives` | `export interface MaintenancePrimitives` |
| 3577 | `VerifierKeyWrite` | `export interface VerifierKeyWrite` |
| 3604 | `BuiltMaintenanceInstruction` | `export interface BuiltMaintenanceInstruction` |
| 3678 | `buildMaintenanceInstruction` | `export function buildMaintenanceInstruction(` |
| 3777 | `attachMaintenanceSignature` | `export function attachMaintenanceSignature(` |
| 3811 | `signatureProgress` | `export function signatureProgress(` |
| 3864 | `OnChainOperation` | `export interface OnChainOperation` |
| 3871 | `OperationsRead` | `export type OperationsRead` |
| 3882 | `operationsFromContractState` | `export function operationsFromContractState(` |
| 3932 | `VerifierKeyVerdict` | `export type VerifierKeyVerdict = 'agree' \| 'disagree' \| 'unknown';` |
| 3934 | `VerifierKeyComparison` | `export interface VerifierKeyComparison` |
| 3975 | `compareVerifierKeys` | `export function compareVerifierKeys(` |

### `src/midnight/ledger.ts` — what it refuses

| line | kind | message |
|---|---|---|
| 514 | throw | cannot open "[value]": this MidnightLedger was built without deployment credentials. Deploying needs a maintenance authority and somewhere to record the address the chain assigns, and a client that only calls an existing account has no business holding either. |
| 551 | throw | cannot open "[value]": the opening names no founding signer. The account's first seat is the leaf handed to the constructor, and an account deployed without one can never have a signer added — `amendSigner` requires an existing signer, so there would be nobody able to seat the first. |
...
| 634 | throw | cannot open "[value]": a threshold of [value] is not a rule. It is refused here because it would enter our own record of the account as its policy. The chain never sees it: since `C340` the constructor takes no threshold and founds every account at one, raised afterwards through the ordinary approval path. |
| 913 | throw | movementsset |
| 980 | throw | propose succeeded but the account state could not be read back, so it is unknown whether the proposal is open. Approvals gathered against it may be unusable.n looked for id: [value]n state read back: none |
| 988 | throw | propose succeeded but the chain has no open proposal with this id. Approvals gathered against it would be unusable.n looked for id: [value]n ids on chain ([value]): none, |
| 999 | throw | propose succeeded but the chain recorded a different change than the one supplied.n on chain: [value]n supplied: [value]nEvery approval gathered against this proposal would be unusable. |
| 1042 | throw | a payroll run must name the vault that will pay it: the vault is folded into the proposal id and recordPayment recomputes the id from the vault it is handed, so a run raised at the no-vault sentinel is one no vault can ever present. |
| 1058 | throw | proposeRun succeeded but the chain has no open proposal with this run's id. Approvals gathered against it would be unusable, and no payment could ever match it. |
| 1065 | throw | proposeRun succeeded but the chain recorded a different change than the one supplied.n on chain: [value]n supplied: [value]nEvery approval gathered against this run would be unusable. |
| 1329 | throw | a governance round cannot name a vault |
| 1358 | throw | a payroll run needs at least one payee |
| 1361 | throw | this run's window closes at [value] and opens at [value], so no payment could ever fall inside it |
| 1373 | throw | [value] is not a time in seconds — that is the year [value]. Block time is seconds since the Unix epoch, not milliseconds. |
| 1440 | throw | the contract has no state on chain |
| 1450 | throw | adding a signer to a live account needs an approved proposal. Propose the signer, reach the threshold, then add them. M-37. |
| 1490 | throw | the contract has no state on chain |
| 1503 | throw | the threshold must be at least one, and a whole number |
| 1511 | throw | the threshold cannot exceed the [value] signers on this account, or one signer could seat their own. |
| 1559 | throw | a vault threshold of zero would authorise anything |
| 1571 | throw | the contract has no state on chain |
| 1574 | throw | that would leave [value] signers against a threshold of [value], and the account could never approve anything again. |
| 1642 | throw | [value] is thirty-two zero bytes. Supply a signer leaf that is neither thirty-two zero bytes nor the vacancy marker. The contract refuses this value — it answers "that is not a usable signer leaf", in its constructor for a founding leaf and in `amendSigner` for a leaf being seated — because thirty-two zero bytes is what an empty slot reads as, so a seat holding it is a seat nothing can ever prove. |
| 1651 | throw | [value] is the vacancy marker itself. Supply a signer leaf that is neither thirty-two zero bytes nor the vacancy marker. The contract refuses this value — it answers "that is not a usable signer leaf", in its constructor for a founding leaf and in `amendSigner` for a leaf being seated — because the tree uses the marker to mean THIS SLOT IS EMPTY, so seating it makes a slot that is simultaneously taken and free. |
| 1683 | throw | the contract has no state on chain |
| 1686 | throw | cannot [value]: there is no open proposal [value] on this account. It has either settled, been cancelled, or was never raised here. |
| 1705 | throw | cannot [value]: that proposal has [value] of [value] approvals. The contract would reject it. |
| 1739 | throw | account not found on this ledger |
| 1741 | throw | account not found on this ledger |
| 1745 | throw | the state for "[value]" is already sealed at key epoch [value]. Re-sealing over an existing epoch would destroy the only copy under that key. |
| 1764 | throw | committed state could not be retrieved for "[value]" at key epoch [value]. Either the blob is missing (M-73), or the account record and the state store disagree about which viewing key is current, which is what a half-finished rotation looks like (K-4). |
| 1800 | throw | account "[value]" is not deployed on Midnight |
| 1873 | throw | no asset blinding in the private state for "[value]" on this device. It is written when the account is opened and every signer needs the same one — without it this device cannot derive the account's asset key, and so cannot compute or check the change commitment a proposal carries. |
| 2086 | throw | the "[value]" call was built without saying where its private state is filed. Pass the key the call was prepared with, or null for a circuit that reads no witness. Passing nothing runs the circuit against no private state at all. |
| 2102 | throw | the "[value]" call was built as though it reads no private state, and it reads one. A circuit that opens with a signer check cannot run without the calling device's own record; pass the key the call was prepared with. |
| 2109 | throw | the "[value]" call was given a private state key and reads no witness at all. Pass null: asking for a record it will not read makes a device that holds none unable to make a call the contract deliberately leaves open to anybody. |
| 2128 | throw | the deployed contract has no circuit "[value]" |
| 2450 | throw | set |
| 2484 | throw | no Compact circuit for "[value]" yet |
| 2485 | throw | not implemented: requires the proof server at |
| 2489 | throw | not implemented: verification happens on chain |
| 2836 | throw | a maintenance authority at threshold [value] is not a committee. Set the threshold to at least one and no more than the number of keys in the committee. A threshold ABOVE the committee size is the unmaintainable state — say { kind: "unmaintainable" } deliberately if that is the intent, rather than reaching it by arithmetic. A threshold BELOW one is WORLD-WRITABLE, not unmaintainable: MEASURED on `@midnightntwrk/ledger-v9@1.0.0-rc.3`, a maintenance update carrying NO SIGNATURES AT ALL is well-formed against an authority at threshold zero, so anybody at all could replace this contract's verifier keys while holding nothing. Committee membership IS still checked — a signature at an out-of-range seat is refused, and so is a wrong signature at a valid seat — what is missing is any requirement to attach one. This refuses rather than comparing the value against the chain. |
| 3301 | throw | this maintenance authority will not be built:n - [[value]] [value]n |
...
| 3704 | throw | these verifier-key writes will not be built:n - [[value]] [value]n |
| 3784 | throw | seat [value] is not a seat on the committee that currently maintains [value]: it holds [value] seat(s), numbered 0 to [value]. The signatures on a maintenance update are checked against the CURRENT committee, not the one being installed. |
| 3792 | throw | seat [value] has already signed this update. A second signature at the same index is refused by the chain as a malformed transaction, and attaching it here would waste a submission rather than add a vote. |
...
| line | site | what fixes it |
|---|---|---|
| 675 | `randomBytes(32)` | a fixed-width random draw |
| 1687 | `.slice(0, 12)` | a fixed-width slice |
| 2727 | `.length === 1` | a width compared |
| 3741 | `.slice(0, 8)` | a fixed-width slice |
| 3987 | `.slice(0, 8)` | a fixed-width slice |
...
- **imported by** — `scripts/deposit-to-vault.ts`, `scripts/fund-vault.ts`, `scripts/open-vault-pool.ts`, `scripts/pay-from-vault-rules.test.ts`, `scripts/pay-from-vault-rules.ts`, `scripts/pay-from-vault.ts`, `src/midnight/note-index.test.ts`, `src/midnight/note-index.ts`, `src/midnight/vault-call-convention.test.ts`, `src/midnight/vault-holdings.test.ts`, `src/midnight/vault-holdings.ts`, `src/midnight/vault-ledger.test.ts`, `src/midnight/vault-pool.ts`, `src/midnight/vault-witness-binding.test.ts`, `src/wiring/chain.ts`
...
| 115 | `PoolVersion` | `export interface PoolVersion` |
| 121 | `LoadedNotes` | `export interface LoadedNotes extends VaultNotes` |
| 145 | `NotePool` | `export interface NotePool` |
| 192 | `CallPlan` | `export interface CallPlan` |
| 214 | `planCall` | `export const planCall = (` |
| 260 | `VaultChainUnreadable` | `export class VaultChainUnreadable extends Error` |
| 303 | `VaultPoolDisagreesWithChain` | `export class VaultPoolDisagreesWithChain extends Error` |
| 326 | `VaultCannotAfford` | `export class VaultCannotAfford extends Error` |
| 367 | `VaultAlreadyHoldsNotes` | `export class VaultAlreadyHoldsNotes extends Error` |
| 381 | `VaultLedger` | `export class VaultLedger` |
| 1615 | `toNote` | `export const toNote = (` |
| 1619 | `toHex` | `export { toHex }` |

### `src/midnight/vault-ledger.ts` — what it refuses

| line | kind | message |
|---|---|---|
| 508 | throw | the vault's note [value] changed or left the pool while its place in the chainx27s commitment tree was being read. Nothing is proved or paid. Pay again, and the note will be chosen and read afresh. |
| 601 | throw | the deployed vault has no circuit "[value]" |
| 794 | throw | a run with no payments is not a run |
| 821 | throw | chain-unreadablethe chain could not be read, so nothing has confirmed what this vault holds. THIS IS NOT THE CHAIN SAYING NO and it is still not a reason to pay: an unconfirmed balance is one a run would be sized against |
| 829 | throw | pool-disagreesthe pool and the chain disagree, so this vault has no balance. [value] |
| 841 | throw | notes-do-not-cover |
| 858 | throw | chain-unreadablethe chain could not be read, so nothing has confirmed what this vault holds in public money. THIS IS NOT THE CHAIN SAYING NO, and it is still not a reason to start paying people |
| 875 | throw | public-balance-shortthis run pays [value] of a public token the chain says this vault holds [value] of. A public balance is one number the ledger subtracts from, so the payees before the shortfall settle and the ones after do not |
| 920 | throw | a note of nothing is not a deposit |
| 1027 | throw | a deposit of nothing is not a deposit. It moves no money and would seat a colour in this vault's unshielded token set, which retire then refuses to pass — a way to jam a vault's retirement for free, by anybody, since a deposit needs no approval. |
| 1104 | throw | this payee's address is for [value] and this vault is on [value]. The [value] would be accepted either way, so nothing further down would notice. |
| 1181 | throw | a private payment spends a note, and a note is spent by its place in the chainx27s commitment tree, which is read from the chain just before the payment. No source of the chainx27s events was given, so nothing is proved or paid. Pass the indexerx27s events to payout and pay again. |
| 1216 | throw | the vault paid without asking for a note. The pool cannot be advanced safely; rebuild it from the chain with replayVault before paying again. |
| 1410 | throw | this provider bundle has no queryUnshieldedBalances, so nothing here can say what the chain published for this contractpublic-balance |
| 1421 | throw | the read itself failed: [value]public-balance |
| 1427 | throw | the indexer has no contract action for this address, so it has not published a balance for it yet. That is not a vault holding nothingpublic-balance |
| 1434 | throw | the indexer answered with [value] rather than a list of balances. A shape this client cannot read is our ignorance, not an empty treasurypublic-balance |
| 1452 | throw | one of the indexer's balance rows is not { tokenType: string, balance: bigint }. Skipping it would understate a treasury, so nothing is returnedpublic-balance |
| 1506 | throw | [value] of [value] note(s) in this pool are NOT in the vault's on-chain set, worth [value] between them. The pool claims MORE than the chain will honour, and every one of those notes would be refused at payment time. Unknown to the chain: [value] |
| 1522 | throw | the chain holds [value] note(s) and this pool holds [value]. Every note the pool knows about IS on chain, so the pool claims LESS than the vault holds — a note reached the vault and was never recorded, which is what a crash between a call and the pool write leaves behind. The amount cannot be stated from here, because a commitment discloses nothing. Rebuild the pool from the chain with replayVault. |
| 1545 | throw | the read itself failed: [value] |
| 1555 | throw | the indexer returned no state for this address |
| 1564 | throw | the state did not decode: [value] |
| 1577 | throw | the decoded state has no readable "notes" set. That is not an empty vault — an empty set is a true statement about the vault and a missing one is our ignorance |
...
- **imported by** — `contracts/test/vault-client.test.ts`, `contracts/test/vault-recovery.test.ts`, `scripts/measure-call-cost.ts`, `scripts/pay-from-vault.ts`, `src/midnight/note-index.test.ts`, `src/midnight/note-index.ts`, `src/midnight/vault-holdings.test.ts`, `src/midnight/vault-ledger.test.ts`, `src/midnight/vault-ledger.ts`, `src/midnight/vault-notes.test.ts`, `src/midnight/vault-pool.test.ts`, `src/midnight/vault-pool.ts`
- **outside packages** — *none*
- **platform modules** — *none*
- **circuits named here** — *none*
- **circuits reached** — *through imports, then through what those circuits themselves run* — `ConfidentialAccount.allVaults`, `ConfidentialAccount.assetKeyOf`, `ConfidentialAccount.changeCommitmentOf`, `ConfidentialAccount.noVault`, `ConfidentialAccount.paidMovementOf`, `ConfidentialAccount.payoutLeaf`, `ConfidentialAccount.proposalIdOf`, `ConfidentialAccount.recordPayment`, `ConfidentialAccount.removeSignerPayload`, `ConfidentialAccount.runPayload`, `ConfidentialAccount.setThresholdPayload`, `ConfidentialAccount.setVaultThresholdPayload`, `ConfidentialAccount.signerAddPayload`, `ConfidentialAccount.signerLeaf`, `ConfidentialAccount.signerPublicKey`, `ConfidentialAccount.vacantSlot`, `Vault.deposit`, `Vault.depositUnshielded`, `Vault.heldCommitmentOf`, `Vault.noteBlindingOf`, `Vault.payout`, `Vault.payoutDetails`, `Vault.payoutUnshielded`, `Vault.unshieldedPayoutDetails`
...
- **imported by** — `scripts/pay-from-vault-rules.test.ts`, `scripts/pay-from-vault.ts`, `scripts/transfer-from-vault.test.ts`, `scripts/transfer-from-vault.ts`, `src/core/a-payroll-run-is-always-private.test.ts`, `src/core/ledger-token.test.ts`, `src/core/payroll.ts`
...
*No width here matches the shapes above.* A width this module works to may
arrive in a variable, and this list sees only a number or a capitalised constant.
<!-- GENERATED:END id="modules" body="7e45c3e1622019bb" -->
