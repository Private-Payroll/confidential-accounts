...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      touch: async (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`touch: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const n_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('touch',
                                     'argument 1 (as invoked from Typescript)',
                                     'v.compact line 18 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = await this._touch_0(context, partialProofData, n_0);
        partialProofData.output = { value: [], alignment: [] };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
        return { result: result_0, context: context, gasCost: context.callContext.currentGasCost };
      }
    };
    this.impureCircuits = { touch: this.circuits.touch };
    this.provableCircuits = { touch: this.circuits.touch };
  }
  async initialState(...args_0) {
    ...
    state_0.setOperation('touch', new __compactRuntime.ContractOperation());
  ...
  async _touch_0(context, partialProofData, n_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
...
export const expectedVk = {
  'touch': 'd652c04e5faddd9de0783b994b362333427226da44c70487bc6023b9176f64e5',
};
