 ...
 *
 * This file is about no password existing on any door. It reaches no ledger write - but which ledger the entry point held decided itself from whatever was on the machine.
 *
