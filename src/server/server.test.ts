 ...
 *
 * This file drives sign-in, sessions and the health route. None of its cases reaches a ledger write today - but which ledger the entry point holds decided itself from whatever was on the machine, so the same green run meant different things on a developer's disk and in a clone.
 *
