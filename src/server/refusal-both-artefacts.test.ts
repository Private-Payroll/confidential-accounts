 ...
 *
 * This file is about a refusal reaching both the log and the browser's report. It reaches no ledger write - but which ledger the entry point held decided itself from whatever was on the machine.
 *
