 ...
 *
 * This file is about a company's keyring being opened, and about what the server does and does not hold while it is. Getting to that state means creating a company, and the deployment this product runs on cannot write: it reads a chain and has no wallet.
 *
